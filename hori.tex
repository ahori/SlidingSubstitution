...
Here, $r \leq q$ and $s < N^{1/q}$. Note that this expression is not
...
slowdown ratio is calculated based on the latency having spare nodes
without having any node failure. 
