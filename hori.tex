...
minimize the change of user program, \AH{5) if the new process-to-node
...
network links between 1' and A  \AH{(these are shown in the white boxes)}:
...
\AH{As reported so far, our proposed sliding methods is to reduce the
...
\AH{ULFM~\cite{Bland01082013} supports both shrinking and
...
\AH{Fenix\cite{Gamell:2014:EAO:2683593.2683691} is a farmework to
...
If a machine has one million nodes and 100 jobs are running
